...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate Symptom-Only (SO) synthetic counseling sessions.")
    ...
    prompt_text = load_prompt(PROMPTS_DIR, "symptoms.txt")
    ...
    for i in range(len(profile_list)):
        if id_list[i] not in source_list and i in valid_indices:
            ...
            prompt_template = PromptTemplate(
                input_variables=["client_medical_information", "client_resistance"],
